...
public class StudentScorecard {
    ...
    public static int[][] generateScores(int numStudents) {
        ...
        for (int i = 0; i < numStudents; i++) {
            scores[i][0] = 50 + rand.nextInt(51); // Physics (random 50-100)
            scores[i][1] = 50 + rand.nextInt(51); // Chemistry (random 50-100)
            scores[i][2] = 50 + rand.nextInt(51); // Maths (random 50-100)
        }
        return scores;
    }
